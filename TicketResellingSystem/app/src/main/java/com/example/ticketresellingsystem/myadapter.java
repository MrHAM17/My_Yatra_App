...
//    }
    ...
    public void onBindViewHolder(@NonNull myviewholder holder, int position)
    {
        ...
        holder.dprize.setText(dataholder.get(position).getPrize());
...
///////////////////
    ...
    {
        TextView dname,dsource,ddestination,ddate,dprize,demail;
        public myviewholder(@NonNull View itemView)
        {
            ...
            dprize=(TextView) itemView.findViewById(R.id.displayprize);
