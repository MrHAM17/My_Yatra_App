...
public class dbmanager extends SQLiteOpenHelper
{
    ...
    {
        String qry="create table UserData ( id integer primary key autoincrement, name text, source text, destination text, date text, prize text, email text)";
    ...
    public  String addrecord(String name, String source, String destination, String date, String prize, String email)
    {
